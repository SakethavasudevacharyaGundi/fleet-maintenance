      ...
      {rows.length > 0 && (
        <>
          ...
          <div className="flex gap-0 mb-4" style={{ border: DIV }}>
            ...
            <div className="flex-1 px-4 py-2.5" style={{ borderRight: DIV }}>
              <span className="text-[12px]" style={{ color: "#8A9A5B" }}>Valid</span>
              <div className="text-[22px] font-bold tabular-nums" style={{ fontFamily: MONO, color: "#8A9A5B" }}>{okRows.length}</div>
            </div>
            <div className="flex-1 px-4 py-2.5">
              <span className="text-[12px]" style={{ color: errRows.length > 0 ? "#C4622D" : MUTED }}>Errors</span>
              <div className="text-[22px] font-bold tabular-nums" style={{ fontFamily: MONO, color: errRows.length > 0 ? "#C4622D" : MUTED }}>{errRows.length}</div>
            </div>
          </div>
          ...
          {!imported ? (
            ...
            <p className="text-[13px] font-medium" style={{ color: "#8A9A5B" }}>
              {okRows.length} vehicle{okRows.length !== 1 ? "s" : ""} imported successfully.
            </p>
          )}
        </>
      )}
